...
import OtherCustomizers from "./components/OtherCustomizers";
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 p-4">
        ...
        {currentView === "clock" && <CustomizerView />}
        {currentView !== "catalog" && currentView !== "clock" && (
          <OtherCustomizers productId={currentView} />
        )}
      </main>
    </div>
  );
